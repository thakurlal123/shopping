...
class SngleCategoryScreen extends StatefulWidget {
  final String? categoryId;
  const SngleCategoryScreen(  {super.key, this.categoryId});

  @override
  State<SngleCategoryScreen> createState() => _SngleCategoryScreenState();
}

class _SngleCategoryScreenState extends State<SngleCategoryScreen> {
  @override
